...
def test_person_factory():
    ...
    for _ in range(age_count):
        age_no_stddev = PersonFactory.generate_age(age_range[0], age_range[1], age_range[2])
        age_stddev = PersonFactory.generate_age(age_range[0], age_range[1], age_range[2], (age_range[1] - age_range[0]) / 3)
